...
public class AADLFormalLangParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("AADLFormalLang");
  ...
  { 
    AADLFormalLangParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = AADLFormalLangParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = AADLFormalLangParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(AADLFormalLangParseControllerGenerated.class);
    }
  ...
  { 
    return AADLFormalLangParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
